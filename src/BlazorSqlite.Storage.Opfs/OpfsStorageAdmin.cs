...
/// </remarks>
internal sealed class OpfsStorageAdmin(IJSRuntime? js) : IBlazorSqliteStorageAdmin
{
    ...
    private async ValueTask<IJSObjectReference> ImportAsync(CancellationToken cancellationToken)
    {
        ...
        return await js
            .InvokeAsync<IJSObjectReference>("import", cancellationToken, OpfsStorageProvider.AdminModuleUrl)
            .ConfigureAwait(false);
    }
}
