...
/// </para>
/// </remarks>
public sealed class BlazorSqliteOpfsStorageProvider : IBlazorSqliteStorageProvider
{
    ...
    public BlazorSqliteOpfsStorageProvider(IJSRuntime? js = null)
    {
        _js = js;
        Admin = new BlazorSqliteOpfsStorageAdmin(js);
    }
