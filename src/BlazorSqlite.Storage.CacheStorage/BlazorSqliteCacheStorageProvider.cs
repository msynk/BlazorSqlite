...
/// </remarks>
public sealed class BlazorSqliteCacheStorageProvider : IBlazorSqliteStorageProvider
{
    ...
    public BlazorSqliteCacheStorageProvider(IJSRuntime? js = null)
    {
        _js = js;
        Admin = new BlazorSqliteCacheStorageAdmin(js);
    }
