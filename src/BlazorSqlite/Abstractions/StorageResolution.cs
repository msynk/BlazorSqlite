...
/// </summary>
public sealed record StorageResolution
{
    ...
    public required IReadOnlyList<StorageCandidateOutcome> Attempts { get; init; }
    ...
    /// <see cref="StorageMigrationMode"/> decides the response to.
    /// </summary>
