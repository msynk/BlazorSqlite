...
/// </remarks>
public static partial class BlazorSqliteFeatureGuards
{
    /// <summary>
    ...
    public static void EnsureSupported(string? commandText)
        => EnsureSupported(commandText, BlazorSqliteRuntimeLimits.Unrestricted);

    /// <summary>
    /// Throws when <paramref name="commandText"/> asks for something
    /// <paramref name="limits"/> cannot honour.
    /// </summary>
    public static void EnsureSupported(string? commandText, BlazorSqliteRuntimeLimits limits)
    {
