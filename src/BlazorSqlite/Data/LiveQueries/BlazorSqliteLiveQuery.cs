...
public sealed class BlazorSqliteLiveQuery<T> : IBlazorSqliteLiveQuery<T>
{
    ...
    /// release that too.
    /// </summary>
    internal BlazorSqliteLiveQuery(
        BlazorSqliteConnection connection,
        Func<CancellationToken, Task<T>> execute,
        IEnumerable<string> tables,
        Action? onDispose)
    ...
    private void OnTablesChanged(object? sender, BlazorSqliteTablesChangedEventArgs e)
    {
