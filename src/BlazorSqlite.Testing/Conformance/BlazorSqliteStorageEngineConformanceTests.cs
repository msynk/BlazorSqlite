...
/// <summary>
/// Engine-level rules every backend must satisfy once a real database is open. Inherit it next
/// to <see cref="BlazorSqliteStorageProviderConformanceTests"/> and return an already-opened
/// transport.
/// </summary>
/// <remarks>
...
/// </remarks>
public abstract class BlazorSqliteStorageEngineConformanceTests : IAsyncDisposable
{
    ...
    /// second connection.
    /// </summary>
    protected abstract ValueTask<IBlazorSqliteTransport> CreateOpenTransportAsync();
